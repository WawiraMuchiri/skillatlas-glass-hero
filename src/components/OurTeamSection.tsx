...
const OurTeamSection = () => (
  <section id="our-team" className="py-24 bg-[#0f2027]">
    <div className="container mx-auto px-6">
      ...
      >
        <div className="w-full max-w-md rounded-[10px] shadow-lg overflow-hidden backdrop-blur-sm" style={{ background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(45,212,191,0.20)' }}>
          <img
            src={foundingTeam}
